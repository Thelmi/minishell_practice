...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   export_no_arg_practice.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mrhelmy <mrhelmy@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/18 23:14:17 by mrhelmy           #+#    #+#             */
/*   Updated: 2024/08/21 15:20:20 by mrhelmy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void sort_array(t_env **env_arr, int count)
{
    ...
    while (i < count - 1)
    {
        ...
        while (j < count)
        {
            if (t_strcmp(env_arr[i]->variable, env_arr[j]->variable) > 0)
            {
                tmp = env_arr[i];
                env_arr[i] = env_arr[j];
                env_arr[j] = tmp;
